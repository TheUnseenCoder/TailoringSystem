...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['matrix_name']) && isset($_POST['size_name']) && isset($_POST['measurement_size']) && isset($_POST['additional']) && isset($_POST['measurement_name']) && is_array($_POST['size_name']) && is_array($_POST['measurement_size'])) {
        // Get the form data
        ...
        foreach ($size_name as $key => $size_names) {
            ...
            $stmt->bind_param("sssss", $matrix_name, $measurement_names, $measurement_size, $size_names, $additional);
            if ($stmt->execute()) {
        ...
        echo "Error: Required fields are missing or size_name/measurement_size is not an array";
    }
} else {
