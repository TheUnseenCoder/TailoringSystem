            ...
            <table id="myTable" class="table text-nowrap mb-0 align-middle" style="justify-content: center;">
                <thead class="text-dark fs-4">
                  <tr>
                    ...
                    <th class="border-bottom-0">
                        <h6 class="fw-semibold mb-0 text-center" style="background-color: black; color: white;">Phone</h6>
                    </th>
                    <th class="border-bottom-0">
                        <h6 class="fw-semibold mb-0 text-center" style="background-color: black; color: white;">Gender</h6>
                    </th>
                    <th class="border-bottom-0">
...
?>
<div class="modal fade" id="view-modal<?php echo $row1['id']; ?>" tabindex="-1" aria-labelledby="viewInquiryModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewInquiryModal">View Product</h5>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <center><h3><?php echo $row1['full_name']; ?></h3></center>
                        </div>
                    </div>
                </div>
                <!-- Product Description -->
                ...
                <div class="mb-3">
                    ...
                    <p><?php echo $row1['inquiry_text']; ?></p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    function reloadTable() {
        fetch('functions/fetch_inquiries.php?page=<?php echo isset($_GET['page']) ? $_GET['page'] : 1; ?>') 
